...
- Right-click on an element (or a blank area), and choose **"Inspect"**  
  to see what the elements are made up of (HTML and CSS).
- You can also edit the HTML or CSS on-the-fly in the **Elements** or **Styles** panel.
